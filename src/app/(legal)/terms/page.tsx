...
export default function TermsPage() {
  return (
    <div className="text-on-surface leading-relaxed">
      <h1 className="font-display text-3xl text-on-surface mb-2">Terms of Service</h1>
      ...
      <p className="text-on-surface-variant mb-4 leading-relaxed">
        These Terms of Service ("Terms") govern your use of PictureBox and its related services.
      ...
      <p className="text-on-surface-variant mb-4 leading-relaxed">
        ...
        <a href="mailto:support@picturebox.app" className="text-gold hover:underline">
      ...
      <p className="text-on-surface-variant mb-4 leading-relaxed">
        You may post reviews, ratings, and other content ("User Content") on PictureBox. You agree
      ...
      <p className="text-on-surface-variant mb-4 leading-relaxed">
        PictureBox is provided "as is" without warranties of any kind, express or implied. We do not
